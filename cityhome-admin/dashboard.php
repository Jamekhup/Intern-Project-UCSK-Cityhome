  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0 text-dark">Upcoming Projects</h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href="addProject.php" class="btn btn-info">Add New Project</a>
              </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                     ...
                     foreach($result as $index => $row){
                        ?>
                          ...
                          <td><img src="project/<?php echo $row['img1']; ?>" alt=""  style="width:50px;height:50px;"></td>

                          <td><img src="project/<?php echo $row['img2']; ?>" alt=""  style="width:50px;height:50px;"></td>
                            ...
                            <?php 
                              ...
                              ?>
                                <form action="process/projectOut.php" method="POST" onsubmit="if(!confirm('Really Sold Out?')){return false;}">
                          ...
                          <td>
                            <a href="editProject.php?id=<?php echo $row['id']; ?>"><i class="fas fa-edit text-info"></i></a>
                          </td>
