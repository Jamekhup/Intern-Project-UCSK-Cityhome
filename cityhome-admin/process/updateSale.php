<?php  
	...
	if (isset($_POST['update'])) {
        ...
        $target1 = "../sale/".$fileName1."_".time().".".$fileExt1;
        ...
        $target2 = "../sale/".$fileName2."_".time().".".$fileExt2;
        ...
        $target3 = "../sale/".$fileName3."_".time().".".$fileExt3;
        ...
        $target4 = "../sale/".$fileName4."_".time().".".$fileExt4;
        ...
        $target5 = "../sale/".$fileName5."_".time().".".$fileExt5;
        ...
        $target6 = "../sale/".$fileName6."_".time().".".$fileExt6;
        ...
        $target7 = "../sale/".$fileName7."_".time().".".$fileExt7;
        ...
        $target8 = "../sale/".$fileName8."_".time().".".$fileExt8;
        ...
        $target9 = "../sale/".$fileName9."_".time().".".$fileExt9;
        ...
        $target10 = "../sale/".$fileName10."_".time().".".$fileExt10;
        ...
        $target11 = "../sale/".$fileName11."_".time().".".$fileExt11;
        ...
        $target12 = "../sale/".$fileName12."_".time().".".$fileExt12;
        ...
        $target13 = "../sale/".$fileName13."_".time().".".$fileExt13;
        ...
        $target14 = "../sale/".$fileName14."_".time().".".$fileExt14;
        ...
        $target15 = "../sale/".$fileName15."_".time().".".$fileExt15;
        ...
        $target16 = "../sale/".$fileName16."_".time().".".$fileExt16;
        ...
        $target17 = "../sale/".$fileName17."_".time().".".$fileExt17;
        ...
        $target18 = "../sale/".$fileName18."_".time().".".$fileExt18;
        ...
        $target19 = "../sale/".$fileName19."_".time().".".$fileExt19;
        ...
        $target20 = "../sale/".$fileName20."_".time().".".$fileExt20;
		...
		if ($address==null||$township==null||$price==null||$category==null||$feet==null||$description==null ||$target1==null||$image1==null) {
			...
			if ($ins1 AND $ins2 || $ins3 || $ins4 || $ins5 || $ins6 || $ins7  ) {
			    	...
			    	$update ="UPDATE for_sale SET address='$address', township='$township', price='$price', room='$room', feet='$feet',description='$description',img1='$image1',img2='$image2',img3='$image3',img4='$image4',img5='$image5',img6='$image6',img7='$image7',img8='$image8',img9='$image9',img10='$image10',img11='$image11',img12='$image12',img13='$image13',img14='$image14',img15='$image15',img16='$image16',img17='$image17',img18='$image18',img19='$image19',img20='$image20',category_name='$category' WHERE id='$update_id'";
