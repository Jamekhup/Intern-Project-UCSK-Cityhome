	...
	if (isset($_POST['submit'])) {
        ...
        $ins20 = move_uploaded_file($_FILES['img20']['tmp_name'], $target20);
			...
			if ($ins1 AND $ins2 || $ins3 || $ins4 || $ins5 || $ins6 || $ins7) {
				 ...
				 $stmt = $dbcon->prepare("INSERT INTO for_sale(address,township,price,room,feet,description,img1,img2,img3,img4,img5,img6,img7,img8,img9,img10,img11,img12,img13,img14,img15,img16,img17,img18,img19,img20,category_name) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
