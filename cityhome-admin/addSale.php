      ...
      <div class="container-fluid">
        <div class="form-group row">
          <div class="col-sm-6 offset-sm-4">
            <h1 class="m-0 text-dark">Add New Data For Sale</h1>
          </div><!-- /.col -->
          <div class="col-sm-2">
    ...
    <!-- Main content -->
      <!-- Horizontal Form -->
            <div class="card card-info col-lg-8 offset-lg-2">
              ...
              <!-- form start -->
              <form class="form-horizontal" action="process/createSale.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" id="exampleFormControlSelect1" name="township">
                        ...
                        <option value="Sule">ဆူးလေမြို့နယ်</option>
                        ...
                        <option value="Mmawbi">မှော်ဘီမြို့နယ်</option>
