<?php  
  ...
  if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM for_sale WHERE id='$edit_id'";
      ...
      <div class="container-fluid">
        <div class="form-group row">
          <div class="col-sm-6 offset-sm-4">
            <h1 class="m-0 text-dark">Edit Data For Sale</h1>
          </div><!-- /.col -->
          <div class="col-sm-2">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="forsale.php">Home</a></li>
              <li class="breadcrumb-item active">Edit For Sale</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
    ...
    <!-- Main content -->
      <!-- Horizontal Form -->
            <div class="card card-info col-lg-8 offset-lg-2">
              <!-- form start -->
              <form class="form-horizontal" action="process/updateSale.php" method="POST" enctype="multipart/form-data">
              <?php  
                          ...
                          <div class="form-group row">
                            ...
                            <div class="form-group col-sm-10">
                              ...
                              <div class="custom-file">
                                <input type="file" name="img1" class="custom-file-input" id="file1" accept="image/*">
                                <label class="custom-file-label" for="customFile" id="lfile1">Image 1</label>
                              </div>
                            </div>
                            </div>  
                          ...
                          <div class="form-group row">
                            ...
                            <div class="form-group col-sm-10">
                              ...
                              <div class="custom-file">
                                ...
                                <label class="custom-file-label" id="lfile7" for="image">Image 7</label>
                              </div>
                            </div>
                            </div>  
                          </div>
