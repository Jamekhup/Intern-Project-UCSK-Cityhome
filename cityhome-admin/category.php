                      ...
                      <tbody>
                       ...
                       foreach($result as $index => $row){
                        ...
                        <tr id="<?php echo $row['id']; ?>">
                          ...
                          <td>
                            <a href="editCategory.php?id=<?php echo $row['id']; ?>"><i class="fas fa-edit text-info"></i></a>

                            <form action="process/delCategory.php" method="POST" class="float-right" onsubmit="if(!confirm('Are you sure to delete this?')){ return false;}">
