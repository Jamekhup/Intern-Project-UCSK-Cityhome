    ...
    <!-- Main content -->
      <!-- Horizontal Form -->
            <div class="card card-info col-lg-8 offset-lg-2">
              <!-- form start -->
              <form class="form-horizontal" action="process/updateAdmin.php" method="POST">
              <?php  
              ...
              ?>
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" value="<?php echo $edit['name']; ?>" name="name">
                    </div>
                  </div>
                   <div class="form-group row">
                    <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputPrice" value="<?php echo $edit['email']; ?>" name="email">
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputPassword" value="<?php echo $edit['password']; ?>" name="password">
                    </div>
                  </div>
                      <div class="form-group row">
