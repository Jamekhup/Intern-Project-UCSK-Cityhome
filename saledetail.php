...
<head>
  <?php 
    ...
    if (isset($_GET['forsaleId'])) {
      require_once('cityhome-admin/db.php');

      $id = $_GET['forsaleId'];

      $sql = "SELECT * FROM for_sale WHERE id='$id' LIMIT 1";
  ...
  ?>
  <title>Property for sale in <?php echo $township; ?> - City Home Propert Co.,ltd</title>
...
<!-- Swiper -->
  <div class="swiper-container gallery-top">
    <div class="swiper-wrapper">
      <div class="swiper-slide" style="background-image:url('cityhome-admin/sale/<?php echo $img1; ?>')"></div>
      <div class="swiper-slide" style="background-image:url('cityhome-admin/sale/<?php echo $img2; ?>')"></div>
      <div class="swiper-slide" style="background-image:url('cityhome-admin/sale/<?php echo $img3; ?>')"></div>
      <div class="swiper-slide" style="background-image:url('cityhome-admin/sale/<?php echo $img4; ?>')"></div>
      <div class="swiper-slide" style="background-image:url('cityhome-admin/sale/<?php echo $img5; ?>')"></div>
      <div class="swiper-slide" style="background-image:url('cityhome-admin/sale/<?php echo $img6; ?>')"></div>
      <div class="swiper-slide" style="background-image:url('cityhome-admin/sale/<?php echo $img7; ?>')"></div>
